...
namespace _13.ComplexTasks
{
    class ComplexTasks
    {
        ...
        static void TaskContinue()
        {
            ...
            {
                Console.WriteLine("Thank you to using the programe!");
            }
            else
            {
        ...
        static void EquationInput()
        {
            ...
            do
            {
                Console.Write("Enter the first number of linear equation - a > 0!");
            ...
            Console.Write("Enter the second number of linear equation - b!");
